...
`].filter(Sr).join(`
`)),o=Ec(o),o=hf(o,t),o=ff(o,t),a=Ec(a),a=hf(a,t),a=ff(a,t),o=df(o),a=df(a),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+p);const T=M+m+o,b=M+p+a,R=lf(s,s.VERTEX_SHADER,T),I=lf(s,s.FRAGMENT_SHADER,b);s.attachShader(x,R),s.attachShader(x,I),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function L(P){if(n.debug.checkShaderErrors){const z=s.getProgramInfoLog(x)||"",G=s.getShaderInfoLog(R)||"",Z=s.getShaderInfoLog(I)||"",q=z.trim(),B=G.trim(),U=Z.trim();let ie=!0,oe=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(ie=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,R,I);else{const Me=uf(s,R,"vertex"),Ee=uf(s,I,"fragment");Oe("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,Yb=[new O(1,0,0),new O(-1,0,0),new O(0,1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1)],jb=[new O(0,-1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1),new O(0,-1,0),new O(0,-1,0)],xf=new je,gr=new O,_l=new O;function $b(n,e,t){let i=new hu;const s=new Qe,r=new Qe,o=new Mt,a=new Px,l=new Lx,c={},u=t.maxTextureSize,h={[Ei]:tn,[tn]:Ei,[Gn]:Gn},f=new hn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Qe},radius:{value:4}},vertexShader:qb,fragmentShader:Kb}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const g=new fn;g.setAttribute("position",new Zt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new nn(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Fo;let p=this.type;this.render=function(I,L,v){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||I.length===0)return;this.type===q_&&(Ne("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Fo);const E=n.getRenderTarget(),j=n.getActiveCubeFace(),P=n.getActiveMipmapLevel(),z=n.state;z.setBlending(Kn),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const G=p!==this.type;G&&L.traverse(function(Z){Z.material&&(Array.isArray(Z.material)?Z.material.forEach(q=>q.needsUpdate=!0):Z.material.needsUpdate=!0)});for(let Z=0,q=I.length;Z<q;Z++){const B=I[Z],U=B.shadow;if(U===void 0){Ne("WebGLShadowMap:",B,"has no shadow.");continue}if(U.autoUpdate===!1&&U.needsUpdate===!1)continue;s.copy(U.mapSize);const ie=U.getFrameExtents();s.multiply(ie),r.copy(U.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/ie.x),s.x=r.x*ie.x,U.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/ie.y),s.y=r.y*ie.y,U.mapSize.y=r.y));const oe=n.state.buffers.depth.getReversed();if(U.camera._reversedDepth=oe,U.map===null||G===!0){if(U.map!==null&&(U.map.depthTexture!==null&&(U.map.depthTexture.dispose(),U.map.depthTexture=null),U.map.dispose()),this.type===vr){if(B.isPointLight){Ne("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}U.map=new Rn(s.x,s.y,{format:Ys,type:Jn,minFilter:Ct,magFilter:Ct,generateMipmaps:!1}),U.map.texture.name=B.name+".shadowMap",U.map.depthTexture=new Gr(s.x,s.y,mn),U.map.depthTexture.name=B.name+".shadowMapDepth",U.map.depthTexture.format=Ai,U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=Rt,U.map.depthTexture.magFilter=Rt}else B.isPointLight?(U.map=new gp(s.x),U.map.depthTexture=new Ax(s.x,Zn)):(U.map=new Rn(s.x,s.y),U.map.depthTexture=new Gr(s.x,s.y,Zn)),U.map.depthTexture.name=B.name+".shadowMap",U.map.depthTexture.format=Ai,this.type===Fo?(U.map.depthTexture.compareFunction=oe?ru:su,U.map.depthTexture.minFilter=Ct,U.map.depthTexture.magFilter=Ct):(U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=Rt,U.map.depthTexture.magFilter=Rt);U.camera.updateProjectionMatrix()}const Me=U.map.isWebGLCubeRenderTarget?6:1;for(let Ee=0;Ee<Me;Ee++){if(U.map.isWebGLCubeRenderTarget)n.setRenderTarget(U.map,Ee),n.clear();else{Ee===0&&(n.setRenderTarget(U.map),n.clear());const _e=U.getViewport(Ee);o.set(r.x*_e.x,r.y*_e.y,r.x*_e.z,r.y*_e.w),z.viewport(o)}if(B.isPointLight){const _e=U.camera,Ge=U.matrix,gt=B.distance||_e.far;gt!==_e.far&&(_e.far=gt,_e.updateProjectionMatrix()),gr.setFromMatrixPosition(B.matrixWorld),_e.position.copy(gr),_l.copy(_e.position),_l.add(Yb[Ee]),_e.up.copy(jb[Ee]),_e.lookAt(_l),_e.updateMatrixWorld(),Ge.makeTranslation(-gr.x,-gr.y,-gr.z),xf.multiplyMatrices(_e.projectionMatrix,_e.matrixWorldInverse),U._frustum.setFromProjectionMatrix(xf,_e.coordinateSystem,_e.reversedDepth)}else U.updateMatrices(B);i=U.getFrustum(),b(L,v,U.camera,B,this.type)}U.isPointLightShadow!==!0&&this.type===vr&&M(U,v),U.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(E,j,P)};function M(I,L){const v=e.update(x);f.defines.VSM_SAMPLES!==I.blurSamples&&(f.defines.VSM_SAMPLES=I.blurSamples,d.defines.VSM_SAMPLES=I.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new Rn(s.x,s.y,{format:Ys,type:Jn})),f.uniforms.shadow_pass.value=I.map.depthTexture,f.uniforms.resolution.value=I.mapSize,f.uniforms.radius.value=I.radius,n.setRenderTarget(I.mapPass),n.clear(),n.renderBufferDirect(L,null,v,f,x,null),d.uniforms.shadow_pass.value=I.mapPass.texture,d.uniforms.resolution.value=I.mapSize,d.uniforms.radius.value=I.radius,n.setRenderTarget(I.map),n.clear(),n.renderBufferDirect(L,null,v,d,x,null)}function T(I,L,v,E){let j=null;const P=v.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(P!==void 0)j=P;else if(j=v.isPointLight===!0?l:a,n.localClippingEnabled&&L.clipShadows===!0&&Array.isArray(L.clippingPlanes)&&L.clippingPlanes.length!==0||L.displacementMap&&L.displacementScale!==0||L.alphaMap&&L.alphaTest>0||L.map&&L.alphaTest>0||L.alphaToCoverage===!0){const z=j.uuid,G=L.uuid;let Z=c[z];Z===void 0&&(Z={},c[z]=Z);let q=Z[G];q===void 0&&(q=j.clone(),Z[G]=q,L.addEventListener("dispose",R)),j=q}if(j.visible=L.visible,j.wireframe=L.wireframe,E===vr?j.side=L.shadowSide!==null?L.shadowSide:L.side:j.side=L.shadowSide!==null?L.shadowSide:h[L.side],j.alphaMap=L.alphaMap,j.alphaTest=L.alphaToCoverage===!0?.5:L.alphaTest,j.map=L.map,j.clipShadows=L.clipShadows,j.clippingPlanes=L.clippingPlanes,j.clipIntersection=L.clipIntersection,j.displacementMap=L.displacementMap,j.displacementScale=L.displacementScale,j.displacementBias=L.displacementBias,j.wireframeLinewidth=L.wireframeLinewidth,j.linewidth=L.linewidth,v.isPointLight===!0&&j.isMeshDistanceMaterial===!0){const z=n.properties.get(j);z.light=v}return j}function b(I,L,v,E,j){if(I.visible===!1)return;if(I.layers.test(L.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&j===vr)&&(!I.frustumCulled||i.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,I.matrixWorld);const G=e.update(I),Z=I.material;if(Array.isArray(Z)){const q=G.groups;for(let B=0,U=q.length;B<U;B++){const ie=q[B],oe=Z[ie.materialIndex];if(oe&&oe.visible){const Me=T(I,oe,E,j);I.onBeforeShadow(n,I,L,v,G,Me,ie),n.renderBufferDirect(v,null,G,Me,I,ie),I.onAfterShadow(n,I,L,v,G,Me,ie)}}}else if(Z.visible){const q=T(I,Z,E,j);I.onBeforeShadow(n,I,L,v,G,q,null),n.renderBufferDirect(v,null,G,q,I,null),I.onAfterShadow(n,I,L,v,G,q,null)}}const z=I.children;for(let G=0,Z=z.length;G<Z;G++)b(z[G],L,v,E,j)}function R(I){I.target.removeEventListener("dispose",R);for(const v in c){const E=c[v],j=I.target.uuid;j in E&&(E[j].dispose(),delete E[j])}}}function Zb(n,e){function t(){let N=!1;const ge=new Mt;let de=null;const Re=new Mt(0,0,0,0);return{setMask:function(ue){de!==ue&&!N&&(n.colorMask(ue,ue,ue,ue),de=ue)},setLocked:function(ue){N=ue},setClear:function(ue,J,Ce,ze,_t){_t===!0&&(ue*=ze,J*=ze,Ce*=ze),ge.set(ue,J,Ce,ze),Re.equals(ge)===!1&&(n.clearColor(ue,J,Ce,ze),Re.copy(ge))},reset:function(){N=!1,de=null,Re.set(-1,0,0,0)}}}function i(){let N=!1,ge=!1,de=null,Re=null,ue=null;return{setReversed:function(J){if(ge!==J){const Ce=e.get("EXT_clip_control");J?Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.ZERO_TO_ONE_EXT):Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.NEGATIVE_ONE_TO_ONE_EXT),ge=J;const ze=ue;ue=null,this.setClear(ze)}},getReversed:function(){return ge},setTest:function(J){J?fe(n.DEPTH_TEST):pe(n.DEPTH_TEST)},setMask:function(J){de!==J&&!N&&(n.depthMask(J),de=J)},setFunc:function(J){if(ge&&(J=P0[J]),Re!==J){switch(J){case Nl:n.depthFunc(n.NEVER);break;case Ul:n.depthFunc(n.ALWAYS);break;case Fl:n.depthFunc(n.LESS);break;case Xs:n.depthFunc(n.LEQUAL);break;case Ol:n.depthFunc(n.EQUAL);break;case Bl:n.depthFunc(n.GEQUAL);break;case kl:n.depthFunc(n.GREATER);break;case Vl:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Re=J}},setLocked:function(J){N=J},setClear:function(J){ue!==J&&(ue=J,ge&&(J=1-J),n.clearDepth(J))},reset:function(){N=!1,de=null,Re=null,ue=null,ge=!1}}}function s(){let N=!1,ge=null,de=null,Re=null,ue=null,J=null,Ce=null,ze=null,_t=null;return{setTest:function(ot){N||(ot?fe(n.STENCIL_TEST):pe(n.STENCIL_TEST))},setMask:function(ot){ge!==ot&&!N&&(n.stencilMask(ot),ge=ot)},setFunc:function(ot,ii,si){(de!==ot||Re!==ii||ue!==si)&&(n.stencilFunc(ot,ii,si),de=ot,Re=ii,ue=si)},setOp:function(ot,ii,si){(J!==ot||Ce!==ii||ze!==si)&&(n.stencilOp(ot,ii,si),J=ot,Ce=ii,ze=si)},setLocked:function(ot){N=ot},setClear:function(ot){_t!==ot&&(n.clearStencil(ot),_t=ot)},reset:function(){N=!1,ge=null,de=null,Re=null,ue=null,J=null,Ce=null,ze=null,_t=null}}}const r=new t,o=new i,a=new s,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,d=[],g=null,x=!1,m=null,p=null,M=null,T=null,b=null,R=null,I=null,L=new ke(0,0,0),v=0,E=!1,j=null,P=null,z=null,G=null,Z=null;const q=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,U=0;const ie=n.getParameter(n.VERSION);ie.indexOf("WebGL")!==-1?(U=parseFloat(/^WebGL (\d)/.exec(ie)[1]),B=U>=1):ie.indexOf("OpenGL ES")!==-1&&(U=parseFloat(/^OpenGL ES (\d)/.exec(ie)[1]),B=U>=2);let oe=null,Me={};const Ee=n.getParameter(n.SCISSOR_BOX),_e=n.getParameter(n.VIEWPORT),Ge=new Mt().fromArray(Ee),gt=new Mt().fromArray(_e);function ft(N,ge,de,Re){const ue=new Uint8Array(4),J=n.createTexture();n.bindTexture(N,J),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ce=0;Ce<de;Ce++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(ge,0,n.RGBA,1,1,Re,0,n.RGBA,n.UNSIGNED_BYTE,ue):n.texImage2D(ge+Ce,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ue);return J}const te={};te[n.TEXTURE_2D]=ft(n.TEXTURE_2D,n.TEXTURE_2D,1),te[n.TEXTURE_CUBE_MAP]=ft(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),te[n.TEXTURE_2D_ARRAY]=ft(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),te[n.TEXTURE_3D]=ft(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),fe(n.DEPTH_TEST),o.setFunc(Xs),K(!1),ne(sh),fe(n.CULL_FACE),k(Kn);function fe(N){u[N]!==!0&&(n.enable(N),u[N]=!0)}function pe(N){u[N]!==!1&&(n.disable(N),u[N]=!1)}function Ve(N,ge){return h[N]!==ge?(n.bindFramebuffer(N,ge),h[N]=ge,N===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=ge),N===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=ge),!0):!1}function Fe(N,ge){let de=d,Re=!1;if(N){de=f.get(ge),de===void 0&&(de=[],f.set(ge,de));const ue=N.textures;if(de.length!==ue.length||de[0]!==n.COLOR_ATTACHMENT0){for(let J=0,Ce=ue.length;J<Ce;J++)de[J]=n.COLOR_ATTACHMENT0+J;de.length=ue.length,Re=!0}}else de[0]!==n.BACK&&(de[0]=n.BACK,Re=!0);Re&&n.drawBuffers(de)}function Be(N){return g!==N?(n.useProgram(N),g=N,!0):!1}const w={[ts]:n.FUNC_ADD,[Y_]:n.FUNC_SUBTRACT,[j_]:n.FUNC_REVERSE_SUBTRACT};w[$_]=n.MIN,w[Z_]=n.MAX;const D={[J_]:n.ZERO,[Q_]:n.ONE,[e0]:n.SRC_COLOR,[Ll]:n.SRC_ALPHA,[o0]:n.SRC_ALPHA_SATURATE,[s0]:n.DST_COLOR,[n0]:n.DST_ALPHA,[t0]:n.ONE_MINUS_SRC_COLOR,[Dl]:n.ONE_MINUS_SRC_ALPHA,[r0]:n.ONE_MINUS_DST_COLOR,[i0]:n.ONE_MINUS_DST_ALPHA,[a0]:n.CONSTANT_COLOR,[l0]:n.ONE_MINUS_CONSTANT_COLOR,[c0]:n.CONSTANT_ALPHA,[u0]:n.ONE_MINUS_CONSTANT_ALPHA};function k(N,ge,de,Re,ue,J,Ce,ze,_t,ot){if(N===Kn){x===!0&&(pe(n.BLEND),x=!1);return}if(x===!1&&(fe(n.BLEND),x=!0),N!==K_){if(N!==m||ot!==E){if((p!==ts||b!==ts)&&(n.blendEquation(n.FUNC_ADD),p=ts,b=ts),ot)switch(N){case Vs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case rh:n.blendFunc(n.ONE,n.ONE);break;case oh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case ah:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Oe("WebGLState: Invalid blending: ",N);break}else switch(N){case Vs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case rh:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case oh:Oe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ah:Oe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Oe("WebGLState: Invalid blending: ",N);break}M=null,T=null,R=null,I=null,L.set(0,0,0),v=0,m=N,E=ot}return}ue=ue||ge,J=J||de,Ce=Ce||Re,(ge!==p||ue!==b)&&(n.blendEquationSeparate(w[ge],w[ue]),p=ge,b=ue),(de!==M||Re!==T||J!==R||Ce!==I)&&(n.blendFuncSeparate(D[de],D[Re],D[J],D[Ce]),M=de,T=Re,R=J,I=Ce),(ze.equals(L)===!1||_t!==v)&&(n.blendColor(ze.r,ze.g,ze.b,_t),L.copy(ze),v=_t),m=N,E=!1}function ee(N,ge){N.side===Gn?pe(n.CULL_FACE):fe(n.CULL_FACE);let de=N.side===tn;ge&&(de=!de),K(de),N.blending===Vs&&N.transparent===!1?k(Kn):k(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),r.setMask(N.colorWrite);const Re=N.stencilWrite;a.setTest(Re),Re&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),le(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?fe(n.SAMPLE_ALPHA_TO_COVERAGE):pe(n.SAMPLE_ALPHA_TO_COVERAGE)}function K(N){j!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),j=N)}function ne(N){N!==W_?(fe(n.CULL_FACE),N!==P&&(N===sh?n.cullFace(n.BACK):N===X_?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):pe(n.CULL_FACE),P=N}function A(N){N!==z&&(B&&n.lineWidth(N),z=N)}function le(N,ge,de){N?(fe(n.POLYGON_OFFSET_FILL),(G!==ge||Z!==de)&&(G=ge,Z=de,o.getReversed()&&(ge=-ge),n.polygonOffset(ge,de))):pe(n.POLYGON_OFFSET_FILL)}function se(N){N?fe(n.SCISSOR_TEST):pe(n.SCISSOR_TEST)}function Q(N){N===void 0&&(N=n.TEXTURE0+q-1),oe!==N&&(n.activeTexture(N),oe=N)}function re(N,ge,de){de===void 0&&(oe===null?de=n.TEXTURE0+q-1:de=oe);let Re=Me[de];Re===void 0&&(Re={type:void 0,texture:void 0},Me[de]=Re),(Re.type!==N||Re.texture!==ge)&&(oe!==de&&(n.activeTexture(de),oe=de),n.bindTexture(N,ge||te[N]),Re.type=N,Re.texture=ge)}function S(){const N=Me[oe];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function _(){try{n.compressedTexImage2D(...arguments)}catch(N){Oe("WebGLState:",N)}}function C(){try{n.compressedTexImage3D(...arguments)}catch(N){Oe("WebGLState:",N)}}function H(){try{n.texSubImage2D(...arguments)}catch(N){Oe("WebGLState:",N)}}function $(){try{n.texSubImage3D(...arguments)}catch(N){Oe("WebGLState:",N)}}function W(){try{n.compressedTexSubImage2D(...arguments)}catch(N){Oe("WebGLState:",N)}}function me(){try{n.compressedTexSubImage3D(...arguments)}catch(N){Oe("WebGLState:",N)}}function ae(){try{n.texStorage2D(...arguments)}catch(N){Oe("WebGLState:",N)}}function we(){try{n.texStorage3D(...arguments)}catch(N){Oe("WebGLState:",N)}}function Pe(){try{n.texImage2D(...arguments)}catch(N){Oe("WebGLState:",N)}}function ce(){try{n.texImage3D(...arguments)}catch(N){Oe("WebGLState:",N)}}function he(N){Ge.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),Ge.copy(N))}function xe(N){gt.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),gt.copy(N))}function be(N,ge){let de=c.get(ge);de===void 0&&(de=new WeakMap,c.set(ge,de));let Re=de.get(N);Re===void 0&&(Re=n.getUniformBlockIndex(ge,N.name),de.set(N,Re))}function Te(N,ge){const Re=c.get(ge).get(N);l.get(ge)!==Re&&(n.uniformBlockBinding(ge,Re,N.__bindingPointIndex),l.set(ge,Re))}function We(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},oe=null,Me={},h={},f=new WeakMap,d=[],g=null,x=!1,m=null,p=null,M=null,T=null,b=null,R=null,I=null,L=new ke(0,0,0),v=0,E=!1,j=null,P=null,z=null,G=null,Z=null,Ge.set(0,0,n.canvas.width,n.canvas.height),gt.set(0,0,n.canvas.width,n.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:fe,disable:pe,bindFramebuffer:Ve,drawBuffers:Fe,useProgram:Be,setBlending:k,setMaterial:ee,setFlipSided:K,setCullFace:ne,setLineWidth:A,setPolygonOffset:le,setScissorTest:se,activeTexture:Q,bindTexture:re,unbindTexture:S,compressedTexImage2D:_,compressedTexImage3D:C,texImage2D:Pe,texImage3D:ce,updateUBOMapping:be,uniformBlockBinding:Te,texStorage2D:ae,texStorage3D:we,texSubImage2D:H,texSubImage3D:$,compressedTexSubImage2D:W,compressedTexSubImage3D:me,scissor:he,viewport:xe,reset:We}}function Jb(n,e,t,i,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Qe,u=new WeakMap;let h;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(S,_){return d?new OffscreenCanvas(S,_):Hr("canvas")}function x(S,_,C){let H=1;const $=re(S);if(($.width>C||$.height>C)&&(H=C/Math.max($.width,$.height)),H<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const W=Math.floor(H*$.width),me=Math.floor(H*$.height);h===void 0&&(h=g(W,me));const ae=_?g(W,me):h;return ae.width=W,ae.height=me,ae.getContext("2d").drawImage(S,0,0,W,me),Ne("WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+W+"x"+me+")."),ae}else return"data"in S&&Ne("WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),S;return S}function m(S){return S.generateMipmaps}function p(S){n.generateMipmap(S)}function M(S){return S.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?n.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function T(S,_,C,H,$=!1){if(S!==null){if(n[S]!==void 0)return n[S];Ne("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let W=_;if(_===n.RED&&(C===n.FLOAT&&(W=n.R32F),C===n.HALF_FLOAT&&(W=n.R16F),C===n.UNSIGNED_BYTE&&(W=n.R8)),_===n.RED_INTEGER&&(C===n.UNSIGNED_BYTE&&(W=n.R8UI),C===n.UNSIGNED_SHORT&&(W=n.R16UI),C===n.UNSIGNED_INT&&(W=n.R32UI),C===n.BYTE&&(W=n.R8I),C===n.SHORT&&(W=n.R16I),C===n.INT&&(W=n.R32I)),_===n.RG&&(C===n.FLOAT&&(W=n.RG32F),C===n.HALF_FLOAT&&(W=n.RG16F),C===n.UNSIGNED_BYTE&&(W=n.RG8)),_===n.RG_INTEGER&&(C===n.UNSIGNED_BYTE&&(W=n.RG8UI),C===n.UNSIGNED_SHORT&&(W=n.RG16UI),C===n.UNSIGNED_INT&&(W=n.RG32UI),C===n.BYTE&&(W=n.RG8I),C===n.SHORT&&(W=n.RG16I),C===n.INT&&(W=n.RG32I)),_===n.RGB_INTEGER&&(C===n.UNSIGNED_BYTE&&(W=n.RGB8UI),C===n.UNSIGNED_SHORT&&(W=n.RGB16UI),C===n.UNSIGNED_INT&&(W=n.RGB32UI),C===n.BYTE&&(W=n.RGB8I),C===n.SHORT&&(W=n.RGB16I),C===n.INT&&(W=n.RGB32I)),_===n.RGBA_INTEGER&&(C===n.UNSIGNED_BYTE&&(W=n.RGBA8UI),C===n.UNSIGNED_SHORT&&(W=n.RGBA16UI),C===n.UNSIGNED_INT&&(W=n.RGBA32UI),C===n.BYTE&&(W=n.RGBA8I),C===n.SHORT&&(W=n.RGBA16I),C===n.INT&&(W=n.RGBA32I)),_===n.RGB&&(C===n.UNSIGNED_INT_5_9_9_9_REV&&(W=n.RGB9_E5),C===n.UNSIGNED_INT_10F_11F_11F_REV&&(W=n.R11F_G11F_B10F)),_===n.RGBA){const me=$?ea:et.getTransfer(H);C===n.FLOAT&&(W=n.RGBA32F),C===n.HALF_FLOAT&&(W=n.RGBA16F),C===n.UNSIGNED_BYTE&&(W=me===at?n.SRGB8_ALPHA8:n.RGBA8),C===n.UNSIGNED_SHORT_4_4_4_4&&(W=n.RGBA4),C===n.UNSIGNED_SHORT_5_5_5_1&&(W=n.RGB5_A1)}return(W===n.R16F||W===n.R32F||W===n.RG16F||W===n.RG32F||W===n.RGBA16F||W===n.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function b(S,_){let C;return S?_===null||_===Zn||_===Br?C=n.DEPTH24_STENCIL8:_===mn?C=n.DEPTH32F_STENCIL8:_===Or&&(C=n.DEPTH24_STENCIL8,Ne("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Zn||_===Br?C=n.DEPTH_COMPONENT24:_===mn?C=n.DEPTH_COMPONENT32F:_===Or&&(C=n.DEPTH_COMPONENT16),C}function R(S,_){return m(S)===!0||S.isFramebufferTexture&&S.minFilter!==Rt&&S.minFilter!==Ct?Math.log2(Math.max(_.width,_.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?_.mipmaps.length:1}function I(S){const _=S.target;_.removeEventListener("dispose",I),v(_),_.isVideoTexture&&u.delete(_)}function L(S){const _=S.target;_.removeEventListener("dispose",L),j(_)}function v(S){const _=i.get(S);if(_.__webglInit===void 0)return;const C=S.source,H=f.get(C);if(H){const $=H[_.__cacheKey];$.usedTimes--,$.usedTimes===0&&E(S),Object.keys(H).length===0&&f.delete(C)}i.remove(S)}function E(S){const _=i.get(S);n.deleteTexture(_.__webglTexture);const C=S.source,H=f.get(C);delete H[_.__cacheKey],o.memory.textures--}function j(S){const _=i.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),i.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let H=0;H<6;H++){if(Array.isArray(_.__webglFramebuffer[H]))for(let $=0;$<_.__webglFramebuffer[H].length;$++)n.deleteFramebuffer(_.__webglFramebuffer[H][$]);else n.deleteFramebuffer(_.__webglFramebuffer[H]);_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer[H])}else{if(Array.isArray(_.__webglFramebuffer))for(let H=0;H<_.__webglFramebuffer.length;H++)n.deleteFramebuffer(_.__webglFramebuffer[H]);else n.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&n.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let H=0;H<_.__webglColorRenderbuffer.length;H++)_.__webglColorRenderbuffer[H]&&n.deleteRenderbuffer(_.__webglColorRenderbuffer[H]);_.__webglDepthRenderbuffer&&n.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const C=S.textures;for(let H=0,$=C.length;H<$;H++){const W=i.get(C[H]);W.__webglTexture&&(n.deleteTexture(W.__webglTexture),o.memory.textures--),i.remove(C[H])}i.remove(S)}let P=0;function z(){P=0}function G(){const S=P;return S>=s.maxTextures&&Ne("WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+s.maxTextures),P+=1,S}function Z(S){const _=[];return _.push(S.wrapS),_.push(S.wrapT),_.push(S.wrapR||0),_.push(S.magFilter),_.push(S.minFilter),_.push(S.anisotropy),_.push(S.internalFormat),_.push(S.format),_.push(S.type),_.push(S.generateMipmaps),_.push(S.premultiplyAlpha),_.push(S.flipY),_.push(S.unpackAlignment),_.push(S.colorSpace),_.join()}function q(S,_){const C=i.get(S);if(S.isVideoTexture&&se(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&C.__version!==S.version){const H=S.image;if(H===null)Ne("WebGLRenderer: Texture marked for update but no image data found.");else if(H.complete===!1)Ne("WebGLRenderer: Texture marked for update but image is incomplete");else{te(C,S,_);return}}else S.isExternalTexture&&(C.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,C.__webglTexture,n.TEXTURE0+_)}function B(S,_){const C=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&C.__version!==S.version){te(C,S,_);return}else S.isExternalTexture&&(C.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,C.__webglTexture,n.TEXTURE0+_)}function U(S,_){const C=i.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&C.__version!==S.version){te(C,S,_);return}t.bindTexture(n.TEXTURE_3D,C.__webglTexture,n.TEXTURE0+_)}function ie(S,_){const C=i.get(S);if(S.isCubeDepthTexture!==!0&&S.version>0&&C.__version!==S.version){fe(C,S,_);return}t.bindTexture(n.TEXTURE_CUBE_MAP,C.__webglTexture,n.TEXTURE0+_)}const oe={[Ks]:n.REPEAT,[Wn]:n.CLAMP_TO_EDGE,[Jo]:n.MIRRORED_REPEAT},Me={[Rt]:n.NEAREST,[Gd]:n.NEAREST_MIPMAP_NEAREST,[Mr]:n.NEAREST_MIPMAP_LINEAR,[Ct]:n.LINEAR,[Oo]:n.LINEAR_MIPMAP_NEAREST,[xi]:n.LINEAR_MIPMAP_LINEAR},Ee={[S0]:n.NEVER,[A0]:n.ALWAYS,[y0]:n.LESS,[su]:n.LEQUAL,[b0]:n.EQUAL,[ru]:n.GEQUAL,[T0]:n.GREATER,[E0]:n.NOTEQUAL};function _e(S,_){if(_.type===mn&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Ct||_.magFilter===Oo||_.magFilter===Mr||_.magFilter===xi||_.minFilter===Ct||_.minFilter===Oo||_.minFilter===Mr||_.minFilter===xi)&&Ne("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(S,n.TEXTURE_WRAP_S,oe[_.wrapS]),n.texParameteri(S,n.TEXTURE_WRAP_T,oe[_.wrapT]),(S===n.TEXTURE_3D||S===n.TEXTURE_2D_ARRAY)&&n.texParameteri(S,n.TEXTURE_WRAP_R,oe[_.wrapR]),n.texParameteri(S,n.TEXTURE_MAG_FILTER,Me[_.magFilter]),n.texParameteri(S,n.TEXTURE_MIN_FILTER,Me[_.minFilter]),_.compareFunction&&(n.texParameteri(S,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(S,n.TEXTURE_COMPARE_FUNC,Ee[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Rt||_.minFilter!==Mr&&_.minFilter!==xi||_.type===mn&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||i.get(_).__currentAnisotropy){const C=e.get("EXT_texture_filter_anisotropic");n.texParameterf(S,C.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),i.get(_).__currentAnisotropy=_.anisotropy}}}function Ge(S,_){let C=!1;S.__webglInit===void 0&&(S.__webglInit=!0,_.addEventListener("dispose",I));const H=_.source;let $=f.get(H);$===void 0&&($={},f.set(H,$));const W=Z(_);if(W!==S.__cacheKey){$[W]===void 0&&($[W]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,C=!0),$[W].usedTimes++;const me=$[S.__cacheKey];me!==void 0&&($[S.__cacheKey].usedTimes--,me.usedTimes===0&&E(_)),S.__cacheKey=W,S.__webglTexture=$[W].texture}return C}function gt(S,_,C){return Math.floor(Math.floor(S/C)/_)}function ft(S,_,C,H){const W=S.updateRanges;if(W.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,_.width,_.height,C,H,_.data);else{W.sort((ce,he)=>ce.start-he.start);let me=0;for(let ce=1;ce<W.length;ce++){const he=W[me],xe=W[ce],be=he.start+he.count,Te=gt(xe.start,_.width,4),We=gt(he.start,_.width,4);xe.start<=be+1&&Te===We&&gt(xe.start+xe.count-1,_.width,4)===Te?he.count=Math.max(he.count,xe.start+xe.count-he.start):(++me,W[me]=xe)}W.length=me+1;const ae=n.getParameter(n.UNPACK_ROW_LENGTH),we=n.getParameter(n.UNPACK_SKIP_PIXELS),Pe=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,_.width);for(let ce=0,he=W.length;ce<he;ce++){const xe=W[ce],be=Math.floor(xe.start/4),Te=Math.ceil(xe.count/4),We=be%_.width,N=Math.floor(be/_.width),ge=Te,de=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,We),n.pixelStorei(n.UNPACK_SKIP_ROWS,N),t.texSubImage2D(n.TEXTURE_2D,0,We,N,ge,de,C,H,_.data)}S.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,ae),n.pixelStorei(n.UNPACK_SKIP_PIXELS,we),n.pixelStorei(n.UNPACK_SKIP_ROWS,Pe)}}function te(S,_,C){let H=n.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(H=n.TEXTURE_2D_ARRAY),_.isData3DTexture&&(H=n.TEXTURE_3D);const $=Ge(S,_),W=_.source;t.bindTexture(H,S.__webglTexture,n.TEXTURE0+C);const me=i.get(W);if(W.version!==me.__version||$===!0){t.activeTexture(n.TEXTURE0+C);const ae=et.getPrimaries(et.workingColorSpace),we=_.colorSpace===ki?null:et.getPrimaries(_.colorSpace),Pe=_.colorSpace===ki||ae===we?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Pe);let ce=x(_.image,!1,s.maxTextureSize);ce=Q(_,ce);const he=r.convert(_.format,_.colorSpace),xe=r.convert(_.type);let be=T(_.internalFormat,he,xe,_.colorSpace,_.isVideoTexture);_e(H,_);let Te;const We=_.mipmaps,N=_.isVideoTexture!==!0,ge=me.__version===void 0||$===!0,de=W.dataReady,Re=R(_,ce);if(_.isDepthTexture)be=b(_.format===is,_.type),ge&&(N?t.texStorage2D(n.TEXTURE_2D,1,be,ce.width,ce.height):t.texImage2D(n.TEXTURE_2D,0,be,ce.width,ce.height,0,he,xe,null));else if(_.isDataTexture)if(We.length>0){N&&ge&&t.texStorage2D(n.TEXTURE_2D,Re,be,We[0].width,We[0].height);for(let ue=0,J=We.length;ue<J;ue++)Te=We[ue],N?de&&t.texSubImage2D(n.TEXTURE_2D,ue,0,0,Te.width,Te.height,he,xe,Te.data):t.texImage2D(n.TEXTURE_2D,ue,be,Te.width,Te.height,0,he,xe,Te.data);_.generateMipmaps=!1}else N?(ge&&t.texStorage2D(n.TEXTURE_2D,Re,be,ce.width,ce.height),de&&ft(_,ce,he,xe)):t.texImage2D(n.TEXTURE_2D,0,be,ce.width,ce.height,0,he,xe,ce.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){N&&ge&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Re,be,We[0].width,We[0].height,ce.depth);for(let ue=0,J=We.length;ue<J;ue++)if(Te=We[ue],_.format!==gn)if(he!==null)if(N){if(de)if(_.layerUpdates.size>0){const Ce=Yh(Te.width,Te.height,_.format,_.type);for(const ze of _.layerUpdates){const _t=Te.data.subarray(ze*Ce/Te.data.BYTES_PER_ELEMENT,(ze+1)*Ce/Te.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ue,0,0,ze,Te.width,Te.height,1,he,_t)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ue,0,0,0,Te.width,Te.height,ce.depth,he,Te.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ue,be,Te.width,Te.height,ce.depth,0,Te.data,0,0);else Ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else N?de&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ue,0,0,0,Te.width,Te.height,ce.depth,he,xe,Te.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ue,be,Te.width,Te.height,ce.depth,0,he,xe,Te.data)}else{N&&ge&&t.texStorage2D(n.TEXTURE_2D,Re,be,We[0].width,We[0].height);for(let ue=0,J=We.length;ue<J;ue++)Te=We[ue],_.format!==gn?he!==null?N?de&&t.compressedTexSubImage2D(n.TEXTURE_2D,ue,0,0,Te.width,Te.height,he,Te.data):t.compressedTexImage2D(n.TEXTURE_2D,ue,be,Te.width,Te.height,0,Te.data):Ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):N?de&&t.texSubImage2D(n.TEXTURE_2D,ue,0,0,Te.width,Te.height,he,xe,Te.data):t.texImage2D(n.TEXTURE_2D,ue,be,Te.width,Te.height,0,he,xe,Te.data)}else if(_.isDataArrayTexture)if(N){if(ge&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Re,be,ce.width,ce.height,ce.depth),de)if(_.layerUpdates.size>0){const ue=Yh(ce.width,ce.height,_.format,_.type);for(const J of _.layerUpdates){const Ce=ce.data.subarray(J*ue/ce.data.BYTES_PER_ELEMENT,(J+1)*ue/ce.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,J,ce.width,ce.height,1,he,xe,Ce)}_.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ce.width,ce.height,ce.depth,he,xe,ce.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,be,ce.width,ce.height,ce.depth,0,he,xe,ce.data);else if(_.isData3DTexture)N?(ge&&t.texStorage3D(n.TEXTURE_3D,Re,be,ce.width,ce.height,ce.depth),de&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ce.width,ce.height,ce.depth,he,xe,ce.data)):t.texImage3D(n.TEXTURE_3D,0,be,ce.width,ce.height,ce.depth,0,he,xe,ce.data);else if(_.isFramebufferTexture){if(ge)if(N)t.texStorage2D(n.TEXTURE_2D,Re,be,ce.width,ce.height);else{let ue=ce.width,J=ce.height;for(let Ce=0;Ce<Re;Ce++)t.texImage2D(n.TEXTURE_2D,Ce,be,ue,J,0,he,xe,null),ue>>=1,J>>=1}}else if(We.length>0){if(N&&ge){const ue=re(We[0]);t.texStorage2D(n.TEXTURE_2D,Re,be,ue.width,ue.height)}for(let ue=0,J=We.length;ue<J;ue++)Te=We[ue],N?de&&t.texSubImage2D(n.TEXTURE_2D,ue,0,0,he,xe,Te):t.texImage2D(n.TEXTURE_2D,ue,be,he,xe,Te);_.generateMipmaps=!1}else if(N){if(ge){const ue=re(ce);t.texStorage2D(n.TEXTURE_2D,Re,be,ue.width,ue.height)}de&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,he,xe,ce)}else t.texImage2D(n.TEXTURE_2D,0,be,he,xe,ce);m(_)&&p(H),me.__version=W.version,_.onUpdate&&_.onUpdate(_)}S.__version=_.version}function fe(S,_,C){if(_.image.length!==6)return;const H=Ge(S,_),$=_.source;t.bindTexture(n.TEXTURE_CUBE_MAP,S.__webglTexture,n.TEXTURE0+C);const W=i.get($);if($.version!==W.__version||H===!0){t.activeTexture(n.TEXTURE0+C);const me=et.getPrimaries(et.workingColorSpace),ae=_.colorSpace===ki?null:et.getPrimaries(_.colorSpace),we=_.colorSpace===ki||me===ae?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,we);const Pe=_.isCompressedTexture||_.image[0].isCompressedTexture,ce=_.image[0]&&_.image[0].isDataTexture,he=[];for(let J=0;J<6;J++)!Pe&&!ce?he[J]=x(_.image[J],!0,s.maxCubemapSize):he[J]=ce?_.image[J].image:_.image[J],he[J]=Q(_,he[J]);const xe=he[0],be=r.convert(_.format,_.colorSpace),Te=r.convert(_.type),We=T(_.internalFormat,be,Te,_.colorSpace),N=_.isVideoTexture!==!0,ge=W.__version===void 0||H===!0,de=$.dataReady;let Re=R(_,xe);_e(n.TEXTURE_CUBE_MAP,_);let ue;if(Pe){N&&ge&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Re,We,xe.width,xe.height);for(let J=0;J<6;J++){ue=he[J].mipmaps;for(let Ce=0;Ce<ue.length;Ce++){const ze=ue[Ce];_.format!==gn?be!==null?N?de&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ce,0,0,ze.width,ze.height,be,ze.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ce,We,ze.width,ze.height,0,ze.data):Ne("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ce,0,0,ze.width,ze.height,be,Te,ze.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ce,We,ze.width,ze.height,0,be,Te,ze.data)}}}else{if(ue=_.mipmaps,N&&ge){ue.length>0&&Re++;const J=re(he[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Re,We,J.width,J.height)}for(let J=0;J<6;J++)if(ce){N?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,he[J].width,he[J].height,be,Te,he[J].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,We,he[J].width,he[J].height,0,be,Te,he[J].data);for(let Ce=0;Ce<ue.length;Ce++){const _t=ue[Ce].image[J].image;N?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ce+1,0,0,_t.width,_t.height,be,Te,_t.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ce+1,We,_t.width,_t.height,0,be,Te,_t.data)}}else{N?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,be,Te,he[J]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,We,be,Te,he[J]);for(let Ce=0;Ce<ue.length;Ce++){const ze=ue[Ce];N?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ce+1,0,0,be,Te,ze.image[J]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+J,Ce+1,We,be,Te,ze.image[J])}}}m(_)&&p(n.TEXTURE_CUBE_MAP),W.__version=$.version,_.onUpdate&&_.onUpdate(_)}S.__version=_.version}function pe(S,_,C,H,$,W){const me=r.convert(C.format,C.colorSpace),ae=r.convert(C.type),we=T(C.internalFormat,me,ae,C.colorSpace),Pe=i.get(_),ce=i.get(C);if(ce.__renderTarget=_,!Pe.__hasExternalTextures){const he=Math.max(1,_.width>>W),xe=Math.max(1,_.height>>W);$===n.TEXTURE_3D||$===n.TEXTURE_2D_ARRAY?t.texImage3D($,W,we,he,xe,_.depth,0,me,ae,null):t.texImage2D($,W,we,he,xe,0,me,ae,null)}t.bindFramebuffer(n.FRAMEBUFFER,S),le(_)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,H,$,ce.__webglTexture,0,A(_)):($===n.TEXTURE_2D||$>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,H,$,ce.__webglTexture,W),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ve(S,_,C){if(n.bindRenderbuffer(n.RENDERBUFFER,S),_.depthBuffer){const H=_.depthTexture,$=H&&H.isDepthTexture?H.type:null,W=b(_.stencilBuffer,$),me=_.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;le(_)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,A(_),W,_.width,_.height):C?n.renderbufferStorageMultisample(n.RENDERBUFFER,A(_),W,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,W,_.width,_.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,me,n.RENDERBUFFER,S)}else{const H=_.textures;for(let $=0;$<H.length;$++){const W=H[$],me=r.convert(W.format,W.colorSpace),ae=r.convert(W.type),we=T(W.internalFormat,me,ae,W.colorSpace);le(_)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,A(_),we,_.width,_.height):C?n.renderbufferStorageMultisample(n.RENDERBUFFER,A(_),we,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,we,_.width,_.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Fe(S,_,C){const H=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,S),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=i.get(_.depthTexture);if($.__renderTarget=_,(!$.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),H){if($.__webglInit===void 0&&($.__webglInit=!0,_.depthTexture.addEventListener("dispose",I)),$.__webglTexture===void 0){$.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,$.__webglTexture),_e(n.TEXTURE_CUBE_MAP,_.depthTexture);const Pe=r.convert(_.depthTexture.format),ce=r.convert(_.depthTexture.type);let he;_.depthTexture.format===Ai?he=n.DEPTH_COMPONENT24:_.depthTexture.format===is&&(he=n.DEPTH24_STENCIL8);for(let xe=0;xe<6;xe++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,he,_.width,_.height,0,Pe,ce,null)}}else q(_.depthTexture,0);const W=$.__webglTexture,me=A(_),ae=H?n.TEXTURE_CUBE_MAP_POSITIVE_X+C:n.TEXTURE_2D,we=_.depthTexture.format===is?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(_.depthTexture.format===Ai)le(_)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,we,ae,W,0,me):n.framebufferTexture2D(n.FRAMEBUFFER,we,ae,W,0);else if(_.depthTexture.format===is)le(_)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,we,ae,W,0,me):n.framebufferTexture2D(n.FRAMEBUFFER,we,ae,W,0);else throw new Error("Unknown depthTexture format")}function Be(S){const _=i.get(S),C=S.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==S.depthTexture){const H=S.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),H){const $=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,H.removeEventListener("dispose",$)};H.addEventListener("dispose",$),_.__depthDisposeCallback=$}_.__boundDepthTexture=H}if(S.depthTexture&&!_.__autoAllocateDepthBuffer)if(C)for(let H=0;H<6;H++)Fe(_.__webglFramebuffer[H],S,H);else{const H=S.texture.mipmaps;H&&H.length>0?Fe(_.__webglFramebuffer[0],S,0):Fe(_.__webglFramebuffer,S,0)}else if(C){_.__webglDepthbuffer=[];for(let H=0;H<6;H++)if(t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[H]),_.__webglDepthbuffer[H]===void 0)_.__webglDepthbuffer[H]=n.createRenderbuffer(),Ve(_.__webglDepthbuffer[H],S,!1);else{const $=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,W=_.__webglDepthbuffer[H];n.bindRenderbuffer(n.RENDERBUFFER,W),n.framebufferRenderbuffer(n.FRAMEBUFFER,$,n.RENDERBUFFER,W)}}else{const H=S.texture.mipmaps;if(H&&H.length>0?t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=n.createRenderbuffer(),Ve(_.__webglDepthbuffer,S,!1);else{const $=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,W=_.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,W),n.framebufferRenderbuffer(n.FRAMEBUFFER,$,n.RENDERBUFFER,W)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function w(S,_,C){const H=i.get(S);_!==void 0&&pe(H.__webglFramebuffer,S,S.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),C!==void 0&&Be(S)}function D(S){const _=S.texture,C=i.get(S),H=i.get(_);S.addEventListener("dispose",L);const $=S.textures,W=S.isWebGLCubeRenderTarget===!0,me=$.length>1;if(me||(H.__webglTexture===void 0&&(H.__webglTexture=n.createTexture()),H.__version=_.version,o.memory.textures++),W){C.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(_.mipmaps&&_.mipmaps.length>0){C.__webglFramebuffer[ae]=[];for(let we=0;we<_.mipmaps.length;we++)C.__webglFramebuffer[ae][we]=n.createFramebuffer()}else C.__webglFramebuffer[ae]=n.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){C.__webglFramebuffer=[];for(let ae=0;ae<_.mipmaps.length;ae++)C.__webglFramebuffer[ae]=n.createFramebuffer()}else C.__webglFramebuffer=n.createFramebuffer();if(me)for(let ae=0,we=$.length;ae<we;ae++){const Pe=i.get($[ae]);Pe.__webglTexture===void 0&&(Pe.__webglTexture=n.createTexture(),o.memory.textures++)}if(S.samples>0&&le(S)===!1){C.__webglMultisampledFramebuffer=n.createFramebuffer(),C.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,C.__webglMultisampledFramebuffer);for(let ae=0;ae<$.length;ae++){const we=$[ae];C.__webglColorRenderbuffer[ae]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,C.__webglColorRenderbuffer[ae]);const Pe=r.convert(we.format,we.colorSpace),ce=r.convert(we.type),he=T(we.internalFormat,Pe,ce,we.colorSpace,S.isXRRenderTarget===!0),xe=A(S);n.renderbufferStorageMultisample(n.RENDERBUFFER,xe,he,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ae,n.RENDERBUFFER,C.__webglColorRenderbuffer[ae])}n.bindRenderbuffer(n.RENDERBUFFER,null),S.depthBuffer&&(C.__webglDepthRenderbuffer=n.createRenderbuffer(),Ve(C.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(W){t.bindTexture(n.TEXTURE_CUBE_MAP,H.__webglTexture),_e(n.TEXTURE_CUBE_MAP,_);for(let ae=0;ae<6;ae++)if(_.mipmaps&&_.mipmaps.length>0)for(let we=0;we<_.mipmaps.length;we++)pe(C.__webglFramebuffer[ae][we],S,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,we);else pe(C.__webglFramebuffer[ae],S,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);m(_)&&p(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(me){for(let ae=0,we=$.length;ae<we;ae++){const Pe=$[ae],ce=i.get(Pe);let he=n.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(he=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(he,ce.__webglTexture),_e(he,Pe),pe(C.__webglFramebuffer,S,Pe,n.COLOR_ATTACHMENT0+ae,he,0),m(Pe)&&p(he)}t.unbindTexture()}else{let ae=n.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ae=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ae,H.__webglTexture),_e(ae,_),_.mipmaps&&_.mipmaps.length>0)for(let we=0;we<_.mipmaps.length;we++)pe(C.__webglFramebuffer[we],S,_,n.COLOR_ATTACHMENT0,ae,we);else pe(C.__webglFramebuffer,S,_,n.COLOR_ATTACHMENT0,ae,0);m(_)&&p(ae),t.unbindTexture()}S.depthBuffer&&Be(S)}function k(S){const _=S.textures;for(let C=0,H=_.length;C<H;C++){const $=_[C];if(m($)){const W=M(S),me=i.get($).__webglTexture;t.bindTexture(W,me),p(W),t.unbindTexture()}}}const ee=[],K=[];function ne(S){if(S.samples>0){if(le(S)===!1){const _=S.textures,C=S.width,H=S.height;let $=n.COLOR_BUFFER_BIT;const W=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,me=i.get(S),ae=_.length>1;if(ae)for(let Pe=0;Pe<_.length;Pe++)t.bindFramebuffer(n.FRAMEBUFFER,me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Pe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Pe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,me.__webglMultisampledFramebuffer);const we=S.texture.mipmaps;we&&we.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,me.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,me.__webglFramebuffer);for(let Pe=0;Pe<_.length;Pe++){if(S.resolveDepthBuffer&&(S.depthBuffer&&($|=n.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&($|=n.STENCIL_BUFFER_BIT)),ae){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,me.__webglColorRenderbuffer[Pe]);const ce=i.get(_[Pe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,ce,0)}n.blitFramebuffer(0,0,C,H,0,0,C,H,$,n.NEAREST),l===!0&&(ee.length=0,K.length=0,ee.push(n.COLOR_ATTACHMENT0+Pe),S.depthBuffer&&S.resolveDepthBuffer===!1&&(ee.push(W),K.push(W),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,K)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ee))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ae)for(let Pe=0;Pe<_.length;Pe++){t.bindFramebuffer(n.FRAMEBUFFER,me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Pe,n.RENDERBUFFER,me.__webglColorRenderbuffer[Pe]);const ce=i.get(_[Pe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Pe,n.TEXTURE_2D,ce,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,me.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){const _=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[_])}}}function A(S){return Math.min(s.maxSamples,S.samples)}function le(S){const _=i.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function se(S){const _=o.render.frame;u.get(S)!==_&&(u.set(S,_),S.update())}function Q(S,_){const C=S.colorSpace,H=S.format,$=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||C!==Jt&&C!==ki&&(et.getTransfer(C)===at?(H!==gn||$!==ln)&&Ne("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Oe("WebGLTextures: Unsupported texture color space:",C)),_}function re(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(c.width=S.naturalWidth||S.width,c.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(c.width=S.displayWidth,c.height=S.displayHeight):(c.width=S.width,c.height=S.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=z,this.setTexture2D=q,this.setTexture2DArray=B,this.setTexture3D=U,this.setTextureCube=ie,this.rebindTextures=w,this.setupRenderTarget=D,this.updateRenderTargetMipmap=k,this.updateMultisampleRenderTarget=ne,this.setupDepthRenderbuffer=Be,this.setupFrameBufferTexture=pe,this.useMultisampledRTT=le,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Qb(n,e){function t(i,s=ki){let r;const o=et.getTransfer(s);if(i===ln)return n.UNSIGNED_BYTE;if(i===Zc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Jc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===qd)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Kd)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Wd)return n.BYTE;if(i===Xd)return n.SHORT;if(i===Or)return n.UNSIGNED_SHORT;if(i===$c)return n.INT;if(i===Zn)return n.UNSIGNED_INT;if(i===mn)return n.FLOAT;if(i===Jn)return n.HALF_FLOAT;if(i===Yd)return n.ALPHA;if(i===jd)return n.RGB;if(i===gn)return n.RGBA;if(i===Ai)return n.DEPTH_COMPONENT;if(i===is)return n.DEPTH_STENCIL;if(i===Qc)return n.RED;if(i===eu)return n.RED_INTEGER;if(i===Ys)return n.RG;if(i===tu)return n.RG_INTEGER;if(i===nu)return n.RGBA_INTEGER;if(i===Bo||i===ko||i===Vo||i===zo)if(o===at)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===Bo)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===ko)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Vo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===zo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===Bo)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===ko)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Vo)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===zo)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===zl||i===Hl||i===Gl||i===Wl)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===zl)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Hl)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Gl)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Wl)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Xl||i===ql||i===Kl||i===Yl||i===jl||i===$l||i===Zl)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Xl||i===ql)return o===at?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Kl)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===Yl)return r.COMPRESSED_R11_EAC;if(i===jl)return r.COMPRESSED_SIGNED_R11_EAC;if(i===$l)return r.COMPRESSED_RG11_EAC;if(i===Zl)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Jl||i===Ql||i===ec||i===tc||i===nc||i===ic||i===sc||i===rc||i===oc||i===ac||i===lc||i===cc||i===uc||i===hc)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Jl)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ql)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===ec)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===tc)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===nc)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===ic)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===sc)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===rc)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===oc)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===ac)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===lc)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===cc)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===uc)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===hc)return o===at?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===fc||i===dc||i===pc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===fc)return o===at?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===dc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===pc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===mc||i===gc||i===_c||i===xc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===mc)return r.COMPRESSED_RED_RGTC1_EXT;if(i===gc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===_c)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===xc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Br?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const eT=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class Zr{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const qT=new $r(-1,1,1,-1,0,1);class KT extends fn{constructor(){super(),this.setAttribute("position",new un([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new un([0,2,0,0,2,0],2))}}const YT=new KT;class Tp{constructor(e){this._mesh=new nn(YT,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,qT)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class Ep extends Zr{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof hn?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=du.clone(e.uniforms),this.material=new hn({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Tp(this.material)}render(e,t,i){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=i.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class Ef extends Zr{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,i){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let o,a;this.inverse?(o=0,a=1):(o=1,a=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,o,4294967295),r.buffers.stencil.setClear(a),r.buffers.stencil.setLocked(!0),e.setRenderTarget(i),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class jT extends Zr{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class $T{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const i=e.getSize(new Qe);this._width=i.width,this._height=i.height,t=new Rn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Jn}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Ep(XT),this.copyPass.material.blending=Kn,this.timer=new ev}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());const t=this.renderer.getRenderTarget();let i=!1;for(let s=0,r=this.passes.length;s<r;s++){const o=this.passes[s];if(o.enabled!==!1){if(o.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),o.render(this.renderer,this.writeBuffer,this.readBuffer,e,i),o.needsSwap){if(i){const a=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(a.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(a.EQUAL,1,4294967295)}this.swapBuffers()}Ef!==void 0&&(o instanceof Ef?i=!0:o instanceof jT&&(i=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new Qe);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const i=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(i,s),this.renderTarget2.setSize(i,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(i,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class ZT extends Zr{constructor(e,t,i=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=i,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new ke}render(e,t,i){const s=e.autoClear;e.autoClear=!1;let r,o;this.overrideMaterial!==null&&(o=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:i),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=o),e.autoClear=s}}const JT={name:"FilmShader",uniforms:{tDiffuse:{value:null},time:{value:0},intensity:{value:.5},grayscale:{value:!1}},vertexShader:`
  ...
  `};return Gc(()=>{if(!e.value)return;const c=new lx;c.background=new ke(32896);const u=new jt(45,window.innerWidth/window.innerHeight,.1,100);u.position.set(0,1.5,3),u.lookAt(0,0,0);const h=new cT({canvas:e.value,antialias:!0});h.setSize(window.innerWidth,window.innerHeight),h.setPixelRatio(Math.min(window.devicePixelRatio,2));const f=new $x(16777215,1.5);c.add(f);const d=new Ho(65484,2.5);d.position.set(2,3,2),c.add(d);const g=new Ho(16711816,1.2);g.position.set(-3,-1,-2),c.add(g);const x=new Ho(16777215,1.5);x.position.set(0,0,5),c.add(x);let m=null;new hT().load("/showpage/3DModel/3dHead.glb",v=>{const E=v.scene,j=new ei().setFromObject(E),P=j.getSize(new O),z=Math.max(P.x,P.y,P.z);E.scale.setScalar(1.6/z),j.setFromObject(E);const G=j.getCenter(new O);E.position.sub(G),c.add(E),m=E,v.animations.length>0&&(i=new pv(E),v.animations.forEach(Z=>{i.clipAction(Z).reset().play()})),a=s.elapsedTime,r=!0});const M=new $T(h);M.addPass(new ZT(c,u));const T=new QT(.25);M.addPass(T);const b=new Ep(l);M.addPass(b);function R(){u.aspect=window.innerWidth/window.innerHeight,u.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight),M.setSize(window.innerWidth,window.innerHeight)}window.addEventListener("resize",R);const I=Math.PI*.375;function L(){t=requestAnimationFrame(L);const v=s.getDelta();i&&r&&i.setTime(s.elapsedTime-a),r&&m&&(o+=v,m.rotation.y=Math.sin(o*.5)*I),b.uniforms.time.value+=v,M.render()}L(),Kr(()=>{cancelAnimationFrame(t),window.removeEventListener("resize",R),h.dispose()})}),(c,u)=>(tt(),vt("canvas",{ref_key:"canvas",ref:e,class:"desktop-bg"},null,512))}}),tE=Ri(eE,[["__scopeId","data-v-67ba54f9"]]),nE={class:"desktop"},iE={class:"desktop__icons"},sE=Pn({__name:"Desktop",setup(n){const{windows:e,openWindow:t}=ga();function i(r,o){t({type:"folder",title:o,payload:{categoryId:r},width:400,height:300})}function s(){t({type:"about",title:"About Me",width:380,height:280})}return(r,o)=>(tt(),vt("div",nE,[Wt(tE),mt("div",iE,[(tt(!0),vt(bt,null,Nr(an(Dd),a=>(tt(),_i(ih,{key:a.id,icon:a.icon,label:a.label,onOpen:l=>i(a.id,a.label)},null,8,["icon","label","onOpen"]))),128)),Wt(ih,{icon:"person",label:"About Me",onOpen:s})]),(tt(!0),vt(bt,null,Nr(an(e),a=>(tt(),_i(T_,{key:a.id,window:a},{default:nd(()=>[a.type==="folder"?(tt(),_i(I_,{key:0,payload:a.payload},null,8,["payload"])):a.type==="video-player"?(tt(),_i(V_,{key:1,payload:a.payload},null,8,["payload"])):a.type==="about"?(tt(),_i(G_,{key:2})):jo("",!0)]),_:2},1032,["window"]))),128)),o[0]||(o[0]=mt("div",{class:"desktop__watermark"},[mt("span",null,"Doormats OS")],-1)),Wt(m_,{windows:an(e)},null,8,["windows"])]))}}),rE=Ri(sE,[["__scopeId","data-v-3d1d92d4"]]),oE=Pn({__name:"App",setup(n){return(e,t)=>(tt(),_i(rE))}});n_(oE).mount("#app");
